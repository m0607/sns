...
<div class="card-header shadow-lg"></div> <!--カードヘッダー-->
        ...
        <div class="row">
            <div class="col-10">
                <form action="{{ route('posts.serch') }}" method="get">
                    @csrf
                    <div class="search-form-009 d-flex flex-column justify-content-center input-daterange" id="datepicker" style="margin-left:13rem;">
                        <div class="text-center">
                            <h5>　タイトル・内容・地域　</h5>
                        </div>
                        <input type="text" name="keyword" value="" placeholder="キーワードを入力して下さい" style="margin-bottom:2rem;">
                        <h5>　日付検索　</h5>
                        <div>
                            ...
                            <div class="mt-3">
                                <input type="submit" value="探す" class="btn button-004-1 mx-3" name="serch">
                                <a href="{{ route('posts.create') }}" class="btn button-004-1">新規投稿</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="text-center col-lg-15 mt-5">
    ...
    <body>
        ...
        <div class="d-flex justify-content-around flex-wrap">
            ...
            @section('title', '新規投稿')
            @if($post->del_flg != 1)
            <div class="my-3 mx-auto col-md-4 shadow-lg">
                <div class="card">
                    <div class="card-body">
                        @if(!empty($post->image))
                        ...
                        <p class="favorite-marke">
                            <a class="js-like-toggle loved" href="" data-postid="{{ $post->id }}">
                                <button class="btn like">❤︎</button>
                            </a>
                ...
                <form action="{{ route('posts.serch') }}" method="get">
                    ...
                    <div class="d-flex flex-column justify-content-center input-daterange" id="datepicker" style="margin-left:13rem;">
                        ...
                        <div>
                            ...
                            <div class="mt-3">
                                <input type="submit" value="探す" class="btn button-004-1 mx-3" name="serch">
                                <a href="{{ route('login') }}" class="btn button-004-1">新規投稿</a>
                            </div>
                        </div>
                    </div>
                </form>
